...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2018 at 02:02 PM
...
(1, 1, 'Mount Fuji and Curry Noodles', '2018-01-04 00:00:00', 1, 26, 'assets/image/YuruCampEps1.jpg', 'wistia_async_iz35go3560', '<script src=\"https://fast.wistia.com/embed/medias/iz35go3560.jsonp\" async></script>'),
...
(38, 1, 1, 'Premium', 'Andree Sulistio CHandr', '234234234234234', 'Monthly', NULL, '2018-07-04 10:31:42'),
(39, 1, NULL, 'Premium', 'sdf', '2134123412341234', 'Monthly', '2022-02-23', '2018-10-11 11:17:24');
...
(1, 'EZ', 'MTIzMTIz', 'ez@gmail.com', 'Male', 'Premium', '2018-11-11'),
...
--
ALTER TABLE `paymenthistory`
  MODIFY `PaymentHistoryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
